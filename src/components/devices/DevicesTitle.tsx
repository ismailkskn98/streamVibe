...
const DevicesTitle = () => {
  return (
    <main className="w-full flex flex-col gap-[10px] 2xl:gap-[14px]">
      <h2 className="text-white font-bold text-xl md:text-2xl 2xl:text-4xl ">Size çeşitli cihazlarda akış deneyimi sunuyoruz</h2>
      <p className="text-grey-60 font-light text-sm md:text-base 2xl:text-lg">
